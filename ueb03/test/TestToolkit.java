...
public final class TestToolkit {
    ...
    /**
     * Bestimmt, ob die erzeugten Graphvizbeschreibungen in eine Grafik konvertiert und anschließend
    ...
    /**
     * Schreibt die Graphviz-Repräsentation des übergebenen Baumes ins entsprechende Verzeichnis in
     * die Datei mit dem übergebenen Namen und überprüft, ob sie der erwarteten Graphviz-Datei
     * entspricht.
     * 
    ...
    /**
     * Ermittelt, ob der Inhalt der Dateien fileName1 und fileName2 identisch ist.
     * 
    ...
    public static boolean filesAreEqual(String fileName1, String fileName2) {
        try {
            return Objects.equal(readFile(fileName1), readFile(fileName2));
        } catch (IOException e) {
